...
*P*(*C*<sub>*i*</sub>|*x*<sub>1</sub>, *x*<sub>2</sub>, ..., *x*<sub>*n*</sub>) = *P*(*C*<sub>*i*</sub>) $\\prod\_{i=1}^{n}P(x\_j|C\_i)$,
...
From this, we can see the most frequent wine (Pinot Noir, 0.1203) and the least likely wine (Chenin Blanc, 0.0053).
